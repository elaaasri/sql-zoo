-- Pattern Matching Strings Section:
...
-- 2 - Find the country where the capital is the country plus "City":
SELECT name FROM world 
...
-- 5 - Show the name and the extension where the capital is a proper (non-empty) extension of name of the country:
