...
-- 7 - Show the countries that are big by area (more than 3 million) or big by population (more than 250 million) but not both. Show name, population and area:
...
-- 9 - Show the name and per-capita GDP for those countries with a GDP of at least one trillion, round this value to the nearest 1000: 
